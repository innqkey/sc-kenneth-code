...
public class RestClientsRegistrar implements ImportBeanDefinitionRegistrar,
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ClassLoader classLoader = metadata.getClass().getClassLoader(); //获取注解类的类加载器
        Map<String, Object> attributes =
                metadata.getAnnotationAttributes(EnableRestClient.class.getName());//返回指定注解类型的属性值
        ...
        Stream.of(clientClasses)
                ...
                .forEach(restClientClass -> {
                    ...
                    //将 @RestClient 接口代理实现注册 为 Bean(@Autowired)
    ...
    private static void registerBeanByFactoryBean(String serviceName, Object proxy,
                                           Class<?> restClientClass, BeanDefinitionRegistry registry) {
        String beanName = "RestClient." + serviceName;
